...
class CallbckforAccount(pj.account_CountCallback):

    def __init__(self, account_Count=None):
        pj.account_CountCallback.__init__(self, account_Count)
...
try:
    ...
    account_C = lib.create_account_Count(pj.account_CountConfig("192.168.1.12", "abc", "admin2013"))
